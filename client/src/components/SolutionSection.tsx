        ...
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-10 md:mb-0 relative">
            <img 
              ...
              className="rounded-lg shadow-xl process-step"
            />
            <div className="absolute -top-6 -right-6 bg-accent text-secondary p-4 rounded-lg shadow-lg hidden md:block process-step">
          ...
          <div className="md:w-1/2 md:pl-12">
            ...
            <p className="text-lg mb-6 text-gray-700 process-step">
            ...
            <div className="space-y-6">
              {solutions.map((solution, index) => (
                <div key={index} className="flex items-start process-step">
